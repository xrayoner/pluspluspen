...
public sealed class EnumDisplayConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
        return value switch
        {
            ...
            PenStyleOption.Direct => "Düz",
            PenStyleOption.Soft => "Yumuşak",
            PenStyleOption.FountainPen => "Dolma Kalem",
            PenStyleOption.FeltTip => "Keçeli Kalem",
            ...
            SmoothingPresetOption.Off => "Kapalı",
            SmoothingPresetOption.Low => "Düşük",
            SmoothingPresetOption.Medium => "Orta",
            SmoothingPresetOption.High => "Yüksek",
